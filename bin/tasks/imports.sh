...
# Get latest Matrix-starter version with updates and copy it over to your project
...
# Create latest Matrix-starter development packages for project root level (gulp paths etc.)
source ${SCRIPTS_LOCATION}/tasks/project.sh

# Clean up leftover development files from Matrix-starter
