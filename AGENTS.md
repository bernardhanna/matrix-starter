...
1. Find the closest layout in `reference-blocks/flexi/` or run `scaffold_flexi_block` with `{ layout, label }`
...
5. Run `validate_flexi_blocks`, `validate_theme_structure`, then `theme_build`
