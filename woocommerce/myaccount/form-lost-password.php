...
<form method="post" class="woocommerce-ResetPassword lost_reset_password w-full max-w-max-704 mx-auto border-black-full border-2 border-solid rounded-[10px] laptop:rounded-md-32 text-white">
    <p class="text-reg-font text-white leading-none"><?php echo apply_filters('woocommerce_lost_password_message', esc_html__('Lost your password? Please enter your username or email address. You will receive a link to create a new password via email.', 'woocommerce')); ?></p><?php // @codingStandardsIgnoreLine
                                                                                                                                                                                                                                                                                            ?><p class="pt-4 woocommerce-form-row woocommerce-form-row--first form-row form-row-first"><label for="user_login" class="ml-2 text-mob-xs-font text-white font-bold"><?php esc_html_e('Username or email', 'woocommerce'); ?></label><input class="mt-2 rounded-lg-x h-input text-black-secondary text-mob-xs-font font-laca font-light pl-11 flex w-full max-w-max-704 woocommerce-Input woocommerce-Input--text input-text" type="text" name="user_login" id="user_login" placeholder="<?php esc_html_e('Enter Username or email', 'woocommerce'); ?>" autocomplete="username" /></p>
    <div class="clear"></div><?php do_action('woocommerce_lostpassword_form'); ?>
