 ...
 * @Last Modified time: 2025-03-11 17:03:48
 */
...
<div class="flex flex-col px-4 pb-6 mx-auto w-full md:px-0 max-w-max-1300">
    <a href="javascript:history.back()" class="mb-4 font-light text-base-font hover:underline">&lt; Back</a>
    <h1 class="text-left text-xl-font font-reg420 text-black-full"><?php _e('Cart', 'rolling-donut'); ?></h1>
    <?php matrix_rd_checkout_render_cart_notices(); ?>
...
<form class="px-4 md:px-0 woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
    ...
    <table class="mx-auto w-full shop_table shop_table_responsive cart woocommerce-cart-form__contents max-w-max-1300" cellspacing="0">
    ...
    <div class="mx-auto my-8 w-full max-w-max-1300">
        <div class="flex flex-col-reverse justify-end py-4 w-full border-t border-b border-solid actions md:flex-row md:justify-between border-black-full">
...
<div class="mx-auto w-full max-w-max-1300">
