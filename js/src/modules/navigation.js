...
(function ($) {
  ...
  $('.menu-item a, .dropdown button').on('keyup', function (e) {
    ...
    if (isSubMenuDropdownOpen === 'true' || isMainMenuDropdownOpen === 'true') {
      ...
      // Close menu using Esc key but only if dropdown is open
        if (e.code === 'Escape') {
          ...
          // jscs:enable
          screenReaderSpan.text(matrix_starter_screenReaderText.expand);
    ...
    if (window.innerWidth > responsivenav) {
      ...
      screenReaderSpanPrev.text(matrix_starter_screenReaderText.expand);
      ...
      screenReaderSpanNext.text(matrix_starter_screenReaderText.expand);
    }
  });
  ...
  $('.dropdown-toggle').each(function () {
    $(this).attr('aria-label', `${matrix_starter_screenReaderText.expand_for} ${$(this).prev().text()}`);
  });
  ...
  siteHeaderMenu.find('.dropdown-toggle').on('click', function (e) {
    ...
    $(this).attr(
      'aria-label',
      $(this).attr('aria-label') === `${matrix_starter_screenReaderText.collapse_for} ${$(this).prev().text()}`
        ? `${matrix_starter_screenReaderText.expand_for} ${$(this).prev().text()}`
        : `${matrix_starter_screenReaderText.collapse_for} ${$(this).prev().text()}`,
    );
  });
  ...
  function mobileNav() {
    ...
    menuToggle.on('click', function () {
      ...
      $('#nav-toggle-label').text(
        ...
        $('#nav-toggle-label').text() === matrix_starter_screenReaderText.expand_toggle
          ? matrix_starter_screenReaderText.collapse_toggle
          : matrix_starter_screenReaderText.expand_toggle,
      );

      $(this).attr(
        'aria-label',
        $(this).attr('aria-label') === matrix_starter_screenReaderText.expand_toggle
          ? matrix_starter_screenReaderText.collapse_toggle
          : matrix_starter_screenReaderText.expand_toggle,
      );
