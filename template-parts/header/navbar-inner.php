...
$show_topnav = $args['show_topnav'] ?? true;
...
<section
  ...
  class="navbar h-auto max-lg:flex max-lg:items-center max-lg:py-4 xl:h-nav overflow-visible bg-white transition-colors duration-200 <?php echo $is_thankyou ? 'mb-8 xl:mb-0' : ''; ?>"
  :class="{ 'max-lg:bg-transparent rd-nav--menu-open': open }"
>
  <div class="relative mx-auto w-full max-w-sitewidth px-4">
    <?php if ($show_topnav) : ?>
      <?php
