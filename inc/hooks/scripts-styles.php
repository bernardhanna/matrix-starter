...
} // end matrix_starter_move_jquery_into_footer
...
function enqueue_theme_scripts() {
  ...
  wp_localize_script( 'scripts', 'matrix_starter_screenReaderText', [
  ...
  wp_localize_script( 'scripts', 'matrix_starter_externalLinkDomains', THEME_SETTINGS['external_link_domains_exclude'] );
} // end matrix_starter_scripts
...
function enqueue_polyfills() {
  ...
  if ( file_exists( get_theme_file_path( get_asset_file( 'legacy.js' ) ) ) ) {
    wp_register_script( 'matrix_starter_legacy', '', [], filemtime( get_theme_file_path( get_asset_file( 'legacy.js' ) ) ), false );
    wp_enqueue_script( 'matrix_starter_legacy' );
    wp_add_inline_script( 'matrix_starter_legacy', $script, true );
  }
